...
## In this project, we will measure vibration and temperature using NCD vibration and temperature sensor, ESP32, and ThingSpeak.We will also send different temperature and vibration readings to Google Sheet Using ThingSpeak and IFTTT  for analyzing vibration sensor data.For Creating mail alert using ThingSpeak and IFTTT,can take help from https://github.com/ncdcommunity/Creating-Alert-using-ThingSpeak-ESP32-Long-Range-Wireless-Vibration-And-Temp.
